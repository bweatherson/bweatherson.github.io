...
\subsection{Week 3: Validity and Trees}\label{week-3-validity-and-trees}
...
\subsection{Week 5: Introduction to Modal
Logic}\label{week-5-introduction-to-modal-logic}
...
\textbf{Assignment}: Assignment 4 due Thursday, February 05 at 5pm.

\subsection{Week 6: Proofs in Modal
Logic}\label{week-6-proofs-in-modal-logic}
