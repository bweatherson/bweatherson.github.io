...
The tableau is open. The countermodel takes a bit more work to describe than the previous ones. There are three worlds, $w_1$, $w_{1.1}$ and $w_{1.1.1}$. Every world can access every world \textit{except}, $w_1$ and $w_{1.1.1}$ can access each other. (By the naming convention, $w_1Rw_{1.1}$ and $w_{1.1}Rw_{1.1.1}$; adding reflexivity and symmetry get us the rest of the relations.) $A$ is true at all three worlds, $B$ is true at the first and second, but not the third.
