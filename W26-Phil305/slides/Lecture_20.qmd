...
**Formal statement**
:    For every strategy profile of the opponents, $\pi_i(a, s_{-i}) > \pi_i(b, s_{-i})$.
...
- If Column plays **R**, then **U** gets 2, **D** gets 3. ✗
:::
...
- If Column plays **L**, then **D** gets 3, **D** gets 3. =
- If Column plays **C**, then **D** gets 1, **D** gets 1. =
- If Column plays **R**, then **D** gets 3, **D** gets 2. ✓
...
- **D** weakly dominates **U**.
- No other dominance relations
