...
This is an introductory survey of some formal methods that are of broad philosophical use.

By **introductory** we mean that it doesn't assume any background knowledge. But it's a broad survey, so we'll be moving reasonably fast to cover a range of topics.
...
The discussion sections for the course are led by Brett Thompson.

Their office hours are Monday, 4pm-6pm, in Mason Hall 2455.

You should also drop by their office hours with questions about this course, other philosophy courses, etc.

## Course Website

There is a Github site for the course that has a number of readings on it. This is at:

::: {.columns}
::: {.column width="100%"}
![https://bweatherson.github.io/W26-Phil305-site/](../images/Phil305-QR.png){width="30%"}
:::
:::
...
::: {.columns}
::: {.column width="100%"}
![https://forallx.openlogicproject.org](../images/forallxyyc.png){fig-alt="Cover of forallx book"}
:::
:::
...
- It also goes over the assessment; after this week there are assignments most weeks. There are 12 in total and the best 10 will count towards your grade.
- There will also be mid-term and final tests.
