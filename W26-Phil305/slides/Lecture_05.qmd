...
The quiz went pretty well, and only one question had less than 90% correct answers. So I'll go over that question in the slides, but I'm happy to talk about any of the others.

- $P \vee Q$
- $\neg P$  
- Therefore, $Q$

We needed to identify the correct truth table and determine if the argument is valid.
...
## Error 1: Saying It's Invalid

Some people chose the first option - the correct truth table but claiming the argument is invalid.

To check for validity we have to look at every row where **both premises** are true.

- In those rows, is the conclusion also true?
- If yes in every case, the argument is valid

## Error 1: Why It's Valid

Let's check the rows where both premises are true:

| P | Q | P v Q | ¬P | Q | Both premises true? |
|---|---|-------|----|----|---------------------|
| T | T | T | F | T | No (¬P is false) |
| T | F | T | F | F | No (¬P is false) |
| F | T | **T** | **T** | **T** | **Yes** |
| F | F | F | T | F | No (P v Q is false) |

Only row 3 has both premises true, and in that row the conclusion Q is also true.

Therefore, the argument is **valid**.

## Error 2: Wrong Truth Table for $P \vee Q$

Some people chose the last option, which had this truth table:
...
The error is in row 2: when P is true and Q is false, $P \vee Q$ should be **true**, not false.
...
::: {.content-visible when-format="revealjs"}
![After applying false disjunction rule](../images/tableaux/05-10.svg){height=190px}
:::
...
::: {.content-visible when-format="revealjs"}
![After first false conditional rule](../images/tableaux/05-11.svg){height=306px}
:::
...
::: {.content-visible when-format="revealjs"}
![Complete tree](../images/tableaux/05-12.svg){height=418px}
:::
...
::: {.content-visible when-format="revealjs"}
![Starting the tree](../images/tableaux/05-13.svg){height=80px}
:::
...
::: {.content-visible when-format="revealjs"}
![After applying true conjunction rule](../images/tableaux/05-14.svg){height=190px}
:::
...
::: {.content-visible when-format="revealjs"}
![After applying true conjunction rule twice](../images/tableaux/05-15.svg){height=302px}
:::
...
::: {.content-visible when-format="revealjs"}
![After applying negation rules](../images/tableaux/05-16.svg){height=422px}
:::
...
::: {.content-visible when-format="revealjs"}
![Complete tree with branches](../images/tableaux/05-17.svg){height=561px}
:::
...
::: {.content-visible when-format="revealjs"}
![Starting the first tree](../images/tableaux/05-18.svg){height=80px}
:::
...
::: {.content-visible when-format="revealjs"}
![After applying false conjunction rule](../images/tableaux/05-19.svg){height=213px}
:::
...
::: {.content-visible when-format="revealjs"}
![Complete first tree](../images/tableaux/05-20.svg){height=329px}
:::
...
::: {.content-visible when-format="revealjs"}
![Starting the second tree](../images/tableaux/05-21.svg){height=80px}
:::
...
::: {.content-visible when-format="revealjs"}
![After applying true conjunction rule](../images/tableaux/05-22.svg){height=190px}
:::
...
::: {.content-visible when-format="revealjs"}
![Complete second tree](../images/tableaux/05-23.svg){height=329px}
:::
