...
- We can specify their **payouts**. These are the concrete things the players get. In the first example in @leytonbrown2008, the payout the players get is that their average packet delay is a certain amount. Payouts might be specified in dollars, or grades, or goals, or any thing we like.
