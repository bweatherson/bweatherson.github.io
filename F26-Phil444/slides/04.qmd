...
subtitle: "Lecture 4: Nash Equilibrium"
...
But it only given a bunch of assumptions. Each logician trusts the others to be reasoning perfectly, and trusts that the others trust each other to be reasoning perfectly, and so on. And that 'and so on' covers more and more as the number of players gets larger.
...
::: {.nonincremental}
- Best response and Nash equilibrium give us useful concepts for talking about what rational play might look like in a game.
- Some games have one (pure strategy) Nash equilibrium, some have many, some have none.
- Strict dominance is well-behaved in two respects. First, any order of deletion gives the same answer. Second, the surviving cells include all Nash equilibria.
