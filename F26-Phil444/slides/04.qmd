...
This is exactly the structure that IESDS leans on. Each round of deletion uses one more layer of "I know that you know that..." about rationality. Long IESDS arguments make very strong assumptions.

## Paradoxes of Common Knowledge

There are also genuine paradoxes about common knowledge of rationality, especially in dynamic games. We will come back to those.
...
This is terrrible terminology, but we're stuck with it; it should really be **at least tied for best response**, but I guess that's not so snappy.
