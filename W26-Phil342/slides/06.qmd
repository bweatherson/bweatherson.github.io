...
Pooling is interesting because of the puzzles we already mentioned, but it relates to some pressing contemporary philosophical problems.
...
If uniqueness fails, then one of the motivations for equal weight fails.
...
The thought is that given Uniqueness, saying that someone is rational just is a way to say that you should be like them.
