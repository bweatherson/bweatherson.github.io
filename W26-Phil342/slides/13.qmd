...
That kind of informal grouping looks much more like the model than housing.
...
The point is that the behaviour in the model is being driven by the ways in which it is unrealistic.

# Models

## What Models Are

Any time we make a simplified version of a situation, we are building some kind of model.
