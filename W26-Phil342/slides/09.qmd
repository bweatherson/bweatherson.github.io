...
**Bet 1 (before learning whether $B$):** The group buys a conditional bet from the bookie, "if $B$ turns out true, pays \$1 if $A$", at the group's pooled-prior conditional price of \$0.82. This is a bet that pays \$1 if $A \wedge B$, pays nothing if $\neg A \wedge B$, and the bettor gets their money back (in this case 82 cents) if $\neg B$.
