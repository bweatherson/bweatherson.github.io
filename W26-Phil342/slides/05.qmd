...
Even this minimal condition—giving just two people control over one personal choice each—leads to impossibility.
...
- Least preferred: Person 2 reads it (y)
...
- Most preferred: Person 1 reads it (x)
...
- They accept contractual means

**The incentive to break the contract remains!**
...
- Given z, the book is lying around unread, Lewd rantgs to move to y (his liberal right).
