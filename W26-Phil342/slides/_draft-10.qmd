...
$$\text{GP}_\mathcal{S}(Pr_1, \ldots, Pr_n)(S) = \frac{\sqrt[n]{Pr_1(S) \times \cdots \times Pr_n(S)}}{\sum_{S' \in \mathcal{S}} \sqrt[n]{Pr_1(S') \times \cdots \times Pr_n(S')}}$$

. . .

For any proposition $X$ that is a disjunction of elements from $\mathcal{S}$:

$$\text{GP}_\mathcal{S}(Pr_1, \ldots, Pr_n)(X) = \sum_{\substack{S \in \mathcal{S} \\ S \subseteq X}} \text{GP}_\mathcal{S}(Pr_1, \ldots, Pr_n)(S)$$
...
This will imply that people with low credence get to reall
