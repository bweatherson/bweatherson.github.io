...
Optimists about credit say that credit incentivises behavior that, is collectively, useful for scientific progress.

. . .

One early optimistic account comes from the Columbia Univesity philosopher of science (and everything else) Philip Kitcher (in a 1990 paper). He argued that credit incentives might improve the **division of labour** in science.
...
Kitcher didn't have anything like as detailed as modern model of science, but he did describe how a model like this might work.
...
Perhaps given credit incentives, one of us might be motivated to do something else, because while it not produce as many new results, might produce **distinctive** and hence **credit-earning** results.

## Kitcher's Model

In Kitcher's model, scientists choose between projects. They share an objective assessment of which projects are most promising.

. . .

If they choose based on epistemic merit alone, they all pick the same project. Division of labour fails.

. . .

When credit is allocated by the priority rule (credit goes to whoever makes a discovery first), scientists are attracted to projects where fewer peers are currently working. Their chances of being the one to make the discovery are higher there.
...
The NYU philosopher of science Michael Strevens (in a 2003 paper) argues that this rule, compared to alternatives like sharing credit among all contributors or allocating it based on marginal contribution, puts the strongest incentive on the most promising projects. On his model, it produces the best division of labour.

## Is Credit Good for Division of Labour?

The evidence from models is mixed.

. . .

Muldoon and Weisberg (2011) challenge the Kitcher/Strevens picture. They point out that the models assume scientists know how many others are working on each project. In practice, scientists often have limited information. When they can only observe a few colleagues, credit incentives don't direct them to less popular projects, because they can't tell which projects are less popular.

. . .

De Langhe (2014) raises a different concern: these models focus on dividing labour among known options, but science also involves exploring new possibilities. The priority rule may encourage studying existing theories rather than developing new ones.

# Communism and Sharing

## The Communist Norm

The priority rule has a second benefit beyond division of labour: it promotes the free sharing of scientific findings.

. . .

Merton (1942) calls this the "communist norm." (Would he have called it that four years later?) What science produces is shared. The priority rule supports this because scientists are incentivised to share their findings quickly, before a competitor publishes first.
...
Strevens (2017) argues that until a result becomes publishable, the priority rule gives scientists reason to hide interim findings. Publishing an intermediate step might help a competitor finish the project first.
...
Boyer-Kassem and Imbert (2015) model the growth of academic collaboration.
...
Zollman (2023) shows that fraud can pay even when it's punished. A lucky fraudster who avoids detection for long enough earns higher credit payoffs than an honest researcher. Heesen (2021) shows that early fraud can set a scientist on a more successful career track, creating a compounding advantage.
...
Dasgupta and David (1994) argue that, beyond promoting sharing, the priority rule's main benefit is encouraging speed. Scientists in a priority race dedicate serious effort to finishing first.

## Credit, Speed and Incentives

Zollman (2018) extends this: credit motives get scientists to allocate more time to research and less to leisure. 
...
Merton (1968) describes a pattern he calls "The Matthew Effect": eminent scientists receive more credit for their contributions than they deserve, while unknown scientists receive less than they deserve.
...
Strevens (2006) argues it may not be unfair at all. If credit reflects positive impact on society, and prominent scientists are in fact more influential (their findings reach more people), then they are proportionally more deserving of credit.
...
Kleinberg and Oren (2011), building on Kitcher's model, make a similar argument. When prominent scientists choose a project, their presence drives others away. 

The Matthew effect acts as a symmetry breaker, helping to divide labour.

## A Less Optimistic View

Heesen (2017) offers a less positive analysis. He models a community where academics choose which papers to read based on the author's reputation.
...
Watts and Gilbert (2011) use an agent-based model to argue that a Matthew effect in citations does not help a group find good solutions to problems.

## Network Effects and Credit

Rubin and Schneider (2021) model how network structure affects credit allocation.
...
Rubin (2022) demonstrates a more extreme version of this dynamic.
...
Rossiter (1993) uses historical evidence to document what she calls the "Matilda effect": women receive less credit than men for equivalent work. 

In fields where women and people of colour have historically been excluded, they will tend to be newer and less well-networked.

. . .

Rubin (2022) and Rubin and Schneider (2021) show that homophily (the tendency to connect with people like yourself) exacerbates this. Minority groups, who are smaller and less connected, face persistent credit disadvantage in network models.
...
On the positive side, credit incentives can promote division of labour, sharing of results, and productive effort. On the negative side, they discourage replication, enable fraud, and produce unfair distributions of recognition through the Matthew effect.
