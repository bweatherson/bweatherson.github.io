...
This game is tricky to analyze because the theoretically correct answer is zero.

The only *equilibrium* is that everyone says zero.

And we often analyze games in terms of what the equilibria are.
...
:::: {.column width=50%}
![QR code for focal point game](images/focal_point_qr.png)
::::
...
My trusted coding assistant wanted to put a little ferris wheel icon for London; I half think I should have left that in to see what effect it would have had.
...
On the same page the two-thirds and cities games were, I've posted [a little emulator](../../games/schelling-game.html) for the Schelling model.
...
If you have ideas for 2, leave them in the comments on the announcement for this class, and I'll see which can be implemented.
