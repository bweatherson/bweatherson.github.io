...
Player 1 wins if the coins match; Player 2 wins if they differ. This is a zero-sum game, so there's no room for cooperation.
...
In the Stag Hunt, the problem isn't that rationality *forces* you to defect. The problem is **trust**. Do you trust the other person will hold up their end?
...
- (Defect, Defect) is **not** Pareto optimal since both players could do better
...
The bold numbers are best responses. Both are bold in (Defect, Defect). That tells you it is the Nash equilibrium.
