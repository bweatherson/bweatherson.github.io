...
- **Political philosophy**: Why do we need governments? (Hobbes!)
...
That's it. The payoff matrix captures all three at once.
...
## In-Class Activity: Prisoner's Dilemma

[Placeholder for in-class PD activity]

Pair up with your neighbor. You'll play the Prisoner's Dilemma **five times in a row** against the same person.

. . .

Before you start: think about whether you'd play differently knowing you'll see this person again.
...
Sound familiar? This is basically the Schelling coordination problem we already studied.
...
- Best response to Cooperate: **Defect** (5 > 3)
- Best response to Defect: **Defect** (1 > 0)

. . .

Defect is the best response no matter what. That's what makes it a **dominant strategy**.
...
This game has two equilibria. Which one gets played? That's where focal points come back in.

## Nash's Theorem

A landmark result (John Nash, 1951):

> Every game with a finite number of players and actions has at least one Nash equilibrium.

. . .

The catch: it might require **mixed strategies**---randomly choosing between actions.

. . .

In Matching Pennies, the only Nash equilibrium is both players flipping a fair coin (50/50 Heads or Tails). Any predictable pattern can be exploited by the other player.

## Mixed Strategies

Why would a rational person randomize?

. . .

Think about penalty kicks in football. If the kicker always goes left, the goalie will always dive left. The kicker needs to be **unpredictable**.

. . .

More precisely: in a mixed-strategy equilibrium, each player randomizes in a way that makes the *other* player indifferent between their options.

. . .

If you're not indifferent, you'd want to shift your probabilities, and it wouldn't be an equilibrium.
...
Here's a powerful technique. Consider this game:
...
Step 1: For Player 2, R is dominated by L (or by C). Remove it.

## Iterated Elimination (cont.)
...
Step 2: Now M is dominated by a mix of U and D. Remove it.
...
We've simplified a 3x3 game to 2x2!
...
- Mixed strategies (the idea, if not the math)
:::
