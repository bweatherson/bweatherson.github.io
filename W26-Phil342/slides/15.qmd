...
## In-Class Activity: The Sharing Game

[Placeholder for in-class activity]

Let's play this. Pair up---one person is the brother, one is the sister.

. . .

::: {.nonincremental}
1. Play the game three times, switching roles.
2. Did anyone propose 2-0? Did anyone accept it?
3. Did the actual outcomes match what "rational" players would do?
:::
...
Here's a Nash equilibrium: Player 1 plays A, Player 2 plays "C if A, **E if B**."

. . .

Player 2 is essentially saying: "Don't play B, or I'll play E instead of F." But wait---if Player 1 *did* play B, would Player 2 really choose E (payoff 5) over F (payoff 10)?
...
Here's another Nash equilibrium: Player 1 plays B, Player 2 plays "**D** if A, F if B."

. . .

Player 1 gets 2, Player 2 gets 10. Player 2 is threatening: "If you play A, I'll play D (bad for you)."
...
In our example, the only SPE is: Player 1 plays A, Player 2 plays "C if A, F if B."

. . .

Player 2 plays the best response at *every* point in the tree, even at points that won't be reached. That's what makes the threat credible---or rather, it's what ensures there are no incredible threats.
...
## Discussion: The Trust Game

Here's a simple game to think about:

. . .

1. Player 1 has \$10. They can **send** some amount (say, \$5) to Player 2, or keep it all.
2. Whatever is sent gets **tripled** (so Player 2 receives \$15).
3. Player 2 can then send some amount back to Player 1, or keep it all.

. . .

::: {.nonincremental}
- What does backward induction predict?
- What do you think would actually happen?
- How does this relate to the PD vs. Stag Hunt distinction from last time?
:::

---

## In-Class Activity: The Trust Game

[Placeholder for in-class Trust Game activity]

. . .

Let's play a few rounds. We'll track what people actually do and compare to the backward induction prediction.
...
This doesn't mean game theory is wrong---it means the simple payoff numbers don't capture everything people value. **Reputation, fairness, and social norms** matter too.
