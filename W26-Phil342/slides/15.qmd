...
1. We could try to analyse all dynamic games as strategic games, e.g., analyse chess just as a battle between chess programs.
...
![Ultimatum Game. Or go to bweatherson.github.io/ultimatum-game.html](images/ultimatum.png){width=50%}
...
- Around the same time, economists started taking seriously empirical research on things like the ultimatum game, and realised people did things that 'didn't make sense' even in simple games.
