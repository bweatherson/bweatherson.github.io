...
The pattern of offers and rejections tracked our independent sense of what the social norms, and to some extent social institutions, were in different societies. Where the economy was more based around collective activity (fishing, game hunting), there was more pro-social behavior.

---

Our version

![Ultimatum Game. bweatherson.github.io/games/ultimatum-game.html](images/ultimatum.png){width=50%}
...
- Responders frequently **reject** offers below about 20%
...
This creates some challenges for why we should care about what theory says. Do we treat theory purely as a normative account of what one *should* do, or do we look for circumstances where it is a reasonable *approximation*?
