...
Weatherall and O'Connor (2021) show that conformity can produce polarization. In their model, agents prefer to pick the action they think is best, but they also prefer to match what their neighbours are doing.
...
Holman and Bruner (2015) add an industry agent to a network model. This agent persistently shares data that push toward a favoured theory, which may be the worse one.
...
This is a case where the structure of information flow favours one group at the expense of another, and perhaps at the expense of the overall research community.
...
And the big organising question will be whether there is a good justification for giving credit such a central role.
