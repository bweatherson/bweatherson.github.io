...
He crawls over the ground with a lens. He is fast and silent; he won't talk to anybody.

. . .

Conan Doyle is hitting you over the head with the thought that the two parts are not just doing different work; they *look* different from outside.
...
Historically, this picture doesn't get cleanly stated in the Western^[It is cleanly stated in Buddhist traditions much much earlier, but it's presupposed more than defended in Western traditions until recently.] philosophy/psychology/cognitive science literature until some decades after this, but it's clearly here in popular culture.
...
![A and B are the same shade. Edward H. Adelson, 1995.](../images/Checker_shadow_illusion.svg){.nostretch fig-alt="What looks like a chessboard with a cylinder casting a shadow." width="35%"}

## Adelson's checkershadow deconstructed

![Merging A and B. [Original animation at Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Optical_illusion_greysquares.gif)](../images/checkershadow-reveal.gif){.nostretch fig-alt="An animation that starts with the full checkerboard illusion and progressively strips it back to show squares A and B as a single block of uniform grey." width="35%"}
...
Holmes talks about *deducing* who the killer is, but he's using the term somewhat differently to how we use it, and arguably incorrectly.
...
## Automation circa 2014

::: {layout="[55,45]"}

::: {}
![Randall Munroe, [xkcd 1425](https://xkcd.com/1425/), CC BY-NC](../images/xkcd-1425-tasks.jpg){fig-alt="A comic. A user asks for an app that checks whether a photo was taken in a national park, and whether the photo is of a bird. The programmer says the first is a few hours' work and the second needs a research team and five years."}
:::

::: {}
This is from September 2014.

The joke is that the two requests sound equally reasonable to the person asking, and one of them is a database query while the other is a research programme.

. . .

Going from _this is the location_ and _these are the park locations_ to _is this in a park_ was easily automatable circa 2014. The latter not so much.
:::
...
Merlin Bird Photo ID, built by Cornell Tech, Caltech and the Cornell Lab of Ornithology shipped in December 2016.

Freely available, runs on any smartphone, and 90% accurate.

. . .

By 2024 you could buy binoculars that did it while you looked through them.

## Recent History

Circa 2014, the split between safe and risky methods correlated pretty well with the split between what we knew how to automate and what we didn't know how to automate.

Obviously we've gotten better at automation on the risky side since then.

## Other Methods

So far we've been talking about *dividing up* processing.

Maybe there are things that are neither simply processing nor perception.
...
You have seen a million blades of grass, and none of them have been orange. (They may have been painted orange; none is naturally orange.) You probably expect that this will continue; you won't see (naturally) orange grass out in the quad this afternoon. What makes this expectation sensible?
