...
![A and B are the same shade. Edward H. Adelson, 1995.](../images/Checker_shadow_illusion.svg){.nostretch fig-alt="What looks like a chessboard with a cylinder casting a shadow." width="90%"}

## Adelson's checkershadow deconstructed

![Merging A and B (via Wikipedia)](../images/Optical_illusion_greysquares.gif){.nostretch fig-alt="A gif constructing the previous slide." width="90%"}
